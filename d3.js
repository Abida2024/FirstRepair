...
/* massaged into a single ES6 module by a GLK script processing
the contents of: http://unpkg.com/d3@7.8.3/dist/d3.js
The canonical source for D3 is here:
  https://github.com/d3/d3/blob/main/src/index.js
D3 is organized into a set of components:
...
Links above are provided for documentation. Their contents are collected and concatenated
by unpkg.com, and then lightly massaged by a GLK script, the main effect of which is to
transform the many statements at the end like:
  ...
  exports.foo = foo;
  exports.bar = barThing;
  ...
which are used in pre-ES6 CommonJS modules, into the form used in ES6 modules:
  export {
     ...
     foo,
     barThing as bar,
...
var locale$1;
// GLK: making local "exports" object to keep some pre-ES6 functions happy
const exports = {};
...
// Big list of non-ES6 "exports.foo = foo;" now in ES6 form
export {
  Adder,
  Delaunay,
  FormatSpecifier,
